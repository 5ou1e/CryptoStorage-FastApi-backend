...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_swap_token_id"),
        "swap",
        ["token_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_swap_wallet_id"),
        "swap",
        ["wallet_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_wallet_detail_wallet_id"),
        "wallet_detail",
        ["wallet_id"],
        unique=True,
    )
    op.create_table(
        ...
        sa.Column(
            "winrate",
            sa.DECIMAL(precision=40, scale=5),
            nullable=True,
        ),
        sa.Column(
        ...
        sa.Column(
            "pnl_lt_minus_dot5_percent",
            sa.Float(),
            nullable=True,
        ),
        sa.Column(
            "pnl_minus_dot5_0x_percent",
            sa.Float(),
            nullable=True,
        ),
        sa.Column(
    ...
    op.create_index(
        op.f("ix_wallet_token_token_id"),
        "wallet_token",
        ["token_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_wallet_token_wallet_id"),
        "wallet_token",
        ["wallet_id"],
        unique=False,
    )
