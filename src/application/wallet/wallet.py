...
from src.application.wallet.wallet import (
    WalletDTO,
)
    ...
    async def get_wallet_related_wallets(self, address: str) -> WalletRelatedWalletsDTO:
        ...
        async def t(token_id):
            async with sem:
                ...
                neighbor_buy_activities = await self.swap_repository.get_neighbors_by_token(
                    token_id=token_id,
                ...
                neighbor_sell_activities = await self.swap_repository.get_neighbors_by_token(
                    token_id=token_id,
